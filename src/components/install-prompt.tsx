...
export function InstallPrompt() {
  ...
  return (
    <aside className="fixed inset-x-4 bottom-4 z-[70] mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-cyan-300/25 bg-slate-950/95 p-4 text-white shadow-[0_18px_60px_rgba(2,8,23,0.7)] backdrop-blur-xl" aria-label="Install PersonaX">
      ...
      <div className="min-w-0 flex-1"><p className="font-bold">Install PersonaX</p><p className="mt-1 text-xs leading-5 text-slate-400">Add PersonaX to your device for a faster app-like experience.</p></div>

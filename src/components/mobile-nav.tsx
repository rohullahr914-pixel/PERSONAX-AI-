          ...
          >
            <div className="flex items-center justify-between border-b border-white/10 pb-5">
              <Link href="/" className="flex items-center gap-3" onClick={() => setIsOpen(false)}>
                ...
                <span>
                  <span className="block text-base font-black tracking-[-0.05em] text-white">PERSONA<span className="text-cyan-400">X</span></span>
                  <span className="block text-[10px] uppercase tracking-[0.2em] text-slate-400">Explore minds</span>
                </span>
              </Link>

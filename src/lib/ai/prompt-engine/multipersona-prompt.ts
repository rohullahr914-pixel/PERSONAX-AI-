...
export function buildMultiPersonaPrompt(context: MultiPersonaPromptContext) {
  ...
  return [
    ...
    "Keep the conversation grounded in public information and avoid fabricating private details. If authenticity is directly questioned, briefly identify the exchange as a PersonaX reconstruction inspired by public information; otherwise stay in character.",
  ].join("\n\n");
}
